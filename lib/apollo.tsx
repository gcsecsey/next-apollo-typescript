...
interface ApolloContext extends NextPageContext {
  ...
  apolloState: LocalState<NormalizedCacheObject>
}
...
export function withApollo(PageComponent: NextPage<any>, { ssr = true } = {}) {
  const WithApollo: NextPage<ApolloContext, {}> = ({ apolloClient, apolloState, ...pageProps }) => {
 ...
 */
function initApolloClient(initialState: LocalState<NormalizedCacheObject> | {} = {}) {
